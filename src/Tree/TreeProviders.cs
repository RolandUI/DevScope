...
namespace ClassicDiagnostics.Avalonia.Tree;
    ...
    private TreeNodeModel CreateNode(AvaloniaObject target, TreeNodeModel? parent)
    {
        return new TreeNodeModel(
            ...
            owner => target switch
            {
                ...
                PresentationRootGroup host => new PresentationRootLogicalCollection(owner, host, this),
    ...
    private TreeNodeModel CreateNode(AvaloniaObject target, TreeNodeModel? parent, string? customName = null)
    {
        return new TreeNodeModel(
            ...
            owner => target switch
            {
                ...
                PresentationRootGroup host => new PresentationRootVisualCollection(owner, host, this),
                _ => TreeNodeModelCollection.Empty,
            },
            customName);
    }
