...
internal class ElementsTreeViewModel : ReactiveViewModelBase
{
    ...
    private ElementDetailsViewModel? _details;
    private TreeNodeViewModel? _selectedNode;

    public ElementsTreeViewModel(
    ...
    public ElementDetailsViewModel? Details
    {
        get => _details;
        private set
        {
    ...
    internal void SetDetails(ElementDetailsViewModel? details)
    {
        Details = details;
    }
