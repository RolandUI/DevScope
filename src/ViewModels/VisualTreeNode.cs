    ...
    internal class VisualTreeNode : TreeNode
    {
            ...
            : base(avaloniaObject, parent, customName)
        {
            Children = avaloniaObject switch
            {
                ...
                Controls.ApplicationPage host => new ApplicationHostVisuals(this, host),
        ...
        {
            readonly Controls.ApplicationPage applicationPage;
            CompositeDisposable _subscriptions = new CompositeDisposable(2);
            public ApplicationHostVisuals(TreeNode owner, Controls.ApplicationPage host) :
                base(owner)
            {
