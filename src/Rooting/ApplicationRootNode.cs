...
internal class ApplicationRootNode : PresentationRootNode, ICloseable
{
    ...
    public readonly static StyledProperty<ThemeVariant?> RequestedThemeVariantProperty =
        ThemeVariantScope.RequestedThemeVariantProperty.AddOwner<ApplicationRootNode>();

    public ApplicationRootNode(IDevToolsRootSource source, Application application) : base(source)
    {
